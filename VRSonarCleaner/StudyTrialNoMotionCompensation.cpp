...
StudyTrialNoMotionCompensation::StudyTrialNoMotionCompensation(TrackedDeviceManager* pTDM, std::string fileName, std::string category)
	: m_pTDM(pTDM)
...
StudyTrialNoMotionCompensation::~StudyTrialNoMotionCompensation()
{
	if (m_pPointCloud)
...
void StudyTrialNoMotionCompensation::init()
{
...
void StudyTrialNoMotionCompensation::update()
{
...
void StudyTrialNoMotionCompensation::draw()
{
...
void StudyTrialNoMotionCompensation::refreshColorScale(ColorScaler * colorScaler, std::vector<SonarPointCloud*> clouds)
{
	if (clouds.size() == 0ull)
		return;
