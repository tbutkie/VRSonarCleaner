...
void ViveController::getCursorPoses(Matrix4 * thisCursorPose, Matrix4 * lastCursorPose)
{
...
float ViveController::getCursorRadius()
{
	return cursorRadius;
}
...
bool ViveController::cursorActive()
{
	return m_bShowCursor;
}

bool ViveController::cleaningActive()
{
