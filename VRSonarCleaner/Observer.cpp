#include "TexturedQuadManager.h"
#include "ShaderUtils.h"

TexturedQuadManager::TexturedQuadManager(vr::IVRSystem* pHMD)
: m_pHMD(pHMD)
...
TexturedQuadManager::~TexturedQuadManager()
{	
	for (int nDevice = 0; nDevice < vr::k_unMaxTrackedDeviceCount; ++nDevice)
		delete m_rpTrackedDevices[nDevice];
}

bool TexturedQuadManager::BInit()
{
...
void TexturedQuadManager::handleEvents()
{
...
//-----------------------------------------------------------------------------
void TexturedQuadManager::processVREvent(const vr::VREvent_t & event)
{
...
void TexturedQuadManager::updateControllerStates()
{
...
bool TexturedQuadManager::cleaningModeActive()
{
	return m_pEditController && m_pEditController->cleaningActive();
}

bool TexturedQuadManager::getCleaningCursorData(Matrix4 *thisCursorPose, Matrix4 *lastCursorPose, float *radius)
{
...
bool TexturedQuadManager::getManipulationData(Matrix4 &controllerPose)
{	
...
void TexturedQuadManager::cleaningHit()
{
...
//-----------------------------------------------------------------------------
void TexturedQuadManager::initDevices()
{
	if (!m_pHMD)
		return;
...
//-----------------------------------------------------------------------------
void TexturedQuadManager::setupTrackedDevice(vr::TrackedDeviceIndex_t unTrackedDeviceIndex)
{
...
void TexturedQuadManager::renderTrackedDevices(Matrix4 & matVP)
{
...
void TexturedQuadManager::postRenderUpdate()
{
...
Matrix4 & TexturedQuadManager::getHMDPose()
{
...
// Purpose:
//-----------------------------------------------------------------------------
void TexturedQuadManager::UpdateHMDMatrixPose()
{
	if (!m_pHMD)
		return;
