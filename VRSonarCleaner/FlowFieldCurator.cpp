...
void FlowFieldCurator::draw()
{
	...
	for (auto &cp : m_vCPs)
	{
		Renderer::getInstance().drawPointerLit(cp.second.pos_world, cp.second.end_world, 0.01f * glm::length(dimratio), glm::vec4(1.f, 1.f, 0.f, 1.f), glm::vec4(1.f), glm::vec4(1.f, 0.f, 0.f, 1.f));
	}
